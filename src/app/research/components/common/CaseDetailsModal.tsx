                    ...
                    <table className="min-w-full w-full border-collapse table-fixed">
                      <thead>
                        <tr className="bg-muted/50">
                          <th className="border border-border p-2 text-left text-xs font-medium text-muted-foreground align-top w-56 md:w-64">
                            Field
                          </th>
                          <th className="border border-border p-2 text-left text-xs font-medium text-muted-foreground align-top">
                            Value
                          </th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr className="hover:bg-muted/30">
                          <td className="border border-border p-2 text-sm font-medium w-56 md:w-64">
                            Case Type
                          </td>
                          <td
                            className="border border-border p-2 text-sm whitespace-pre-wrap break-words break-all"
                            style={{
                        ...
                        <tr className="hover:bg-muted/30">
                          ...
                          <td
                            className="border border-border p-2 text-sm font-mono whitespace-pre-wrap break-words break-all"
                            style={{
                              overflowWrap: "anywhere",
                              wordBreak: "break-word",
                            }}
