            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div>
                  ...
                  {caseData.filing_no || "N/A"}
                </div>
                <div>
                  <span className="font-medium">Case Type:</span>{" "}
                  {caseData.type_name || "N/A"}
                </div>
                <div>
                  <span className="font-medium">Filing Year:</span>{" "}
                  {caseData.fil_year || "N/A"}
                </div>
                <div>
                  <span className="font-medium">Filing No:</span>{" "}
                  {caseData.fil_no || "N/A"}
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <div className="space-y-2 text-sm">
                <div>
                  ...
                  {caseData.state_cd || "N/A"}
                </div>
                <div>
                  <span className="font-medium">Court Code:</span>{" "}
                  {caseData.court_code || "N/A"}
                </div>
              </div>
            </div>
          </div>
