        ...
        <div className="space-y-6">
          {Object.entries(filteredResults).map(([courtName, cases]) => {
            ...
            const columns: ColumnDef<DistrictCourtResult>[] = [
              ...
              {
                key: "case_combo",
                header: "CASE TYPE/CASE NUMBER/CASE YEAR",
                width: 150,
                render: (r) => (
                  <div
                    className="max-w-[150px] truncate"
                    title={`${r.case_type || ""}/${r.case_number || ""}/${r.case_year || ""}`}
                  >
                    {(r.case_type || "N/A") +
                      "/" +
                      (r.case_number || "N/A") +
              ...
              {
                key: "party",
                header: "PETITIONER VERSUS RESPONDENT",
                width: 200,
                render: (r) => (
                  ...
                  return (
                    <div className="flex items-center space-x-2">
                      <FollowButton
                        ...
                        onClick={() => {
                          if (!followedCases.has(caseId)) onFollow(r);
                        }}
                        compact
                      />
                      <button
            ...
            return (
              ...
              >
                ...
                <Pagination
                  ...
                  total={total}
                  onPageChange={(p) =>
                    setPageByCourt((prev) => ({ ...prev, [courtName]: p }))
                  }
                  onPageSizeChange={(n) => {
                    setPageSize(n);
